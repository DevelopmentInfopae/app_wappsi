...
class PrintFormat {
    ...
    await bluetooth.isConnected.then((isConnected) async {
      ...
      if (isConnected!) {
        ...
        final generator = Generator(
          chrLen == 32 ? PaperSize.mm58 : PaperSize.mm80,
          profile,
          spaceBetweenRows: 1,
        );
        // delete print buffer
  ...
  Future<List<int>> ticketPayDetails(
    Generator generator,
    bool innerPrinter,
    Map<dynamic, dynamic>? printData,
  ) async {
  ...
  Future<List<int>> ticketOrdQuotValue(
    Generator generator,
    bool innerPrinter,
    Map<dynamic, dynamic>? printData,
  ) async {
  ...
  Future<List<int>> orderDeliveryInfo(
    Generator generator,
    bool innerPrinter,
    Map<dynamic, dynamic>? printData,
  ) async {
  ...
  Future<List<int>> ticketProductsPP6(
    ...
    for (var element in productsList!) {
      List<String> formatedS = formatString(
  ...
  Future<List<int>> ticketFavProducts(
    Generator generator,
    bool innerPrinter,
    ...
    if (data != null) {
      ...
      try {
        if (data['delivery_day'] != null) {
          ...
          bytes += generator.text(
            capitalizeText(formatedDeliveryDay),
            styles: const PosStyles(
              bold: true,
              align: PosAlign.center,
