...
class PaymentsModel {
  ...
  factory PaymentsModel.fromJson(Map<String, dynamic> json) => PaymentsModel(
        ...
        affect: json["affect"],
        trmDifference: json["trm_difference"],
        trmDifferenceLedgerId: json["trm_difference_ledger_id"],
        taxRateTraslate: json["tax_rate_traslate"],
        taxRateTraslateLedgerId: json["tax_rate_traslate_ledger_id"],
        ...
        discountLedgerId: json["discount_ledger_id"],
        commPerc: json["comm_perc"],
        commBase: json["comm_base"],
        commAmount: json["comm_amount"],
        sellerId: json["seller_id"],
        commPaymentStatus: json["comm_payment_status"],
        commPaymentDate: json["comm_payment_date"],
        commPaymentReferenceNo: json["comm_payment_reference_no"],
        conceptLedgerId: json["concept_ledger_id"],
        affectedDepositId: json["affected_deposit_id"],
        ...
        conceptBase: json["concept_base"],
        conceptCompanyId: json["concept_company_id"],
        ...
        commPaidPaymentsIds: json["comm_paid_payments_ids"],
