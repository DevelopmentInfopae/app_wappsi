...
class ProductModel {
  ...
  static Future<bool> saveProductsSpSale(int suspSaleId) async {
    ...
    if (suspSaleId != 0) {
      ...
      result = await ProductsProvider.saveSuspSaleProducts(productsMap);
    }
    return result;
  }
  ...
  static Future<Map<String, dynamic>> loadSuspSaleProducts(
    ...
    final res = await ProductsProvider.loadSuspendedSProducts(suspSaleId);

    List<Map<String, dynamic>> dif = [];
    if (res != null) {
      dif = await ProductsProvider.checkSuspPriceDif(res);
    }
