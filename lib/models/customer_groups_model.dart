...
class CustomerGroupsModel {
  ...
  static Future<Map<String, dynamic>?> loadCustomerGroupFromDB(String id) async {
    return await DBProvider.db.sqlFirstQuery('sma_customer_groups', where: 'id_cloud = $id');
  }

  /// Return a list with customer_groups data wich fields name or percent LIKE
  /// param searchs
  static Future<List<Map<String, dynamic>>?> findCustomerGroup(String searchs) async {
    return await DBProvider.db.sqlQuery('sma_customer_groups',
