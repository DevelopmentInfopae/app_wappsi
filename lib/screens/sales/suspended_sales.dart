...
class _SuspendedSalesScreenState extends State<SuspendedSalesScreen> {
  final _suspendedSalesStream =
      StreamController<List<SuspendedSales>>.broadcast();
  final _searchController = FloatingSearchBarController();

  @override
  void dispose() {
    _suspendedSalesStream.close();
  ...
  _onQueryChanged(String? query) async {
    if (query == '' || query == null) {
      ...
      // if (res != null) {
      _suspendedSalesStream.sink.add(res);
      // }
    } else {
