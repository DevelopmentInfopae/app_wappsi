...
class SuppliersCardList extends StatefulWidget {
  ...
  @override
  State<SuppliersCardList> createState() => _SupplierCardListState();
}

class _SupplierCardListState extends State<SuppliersCardList> {
...
class SuppliersCard extends StatefulWidget {
  ...
  final String action;
  const SuppliersCard({Key? key, required this.customer, required this.action})
      : super(key: key);
