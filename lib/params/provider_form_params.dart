...
//
//                                     Metodo de pago y tipo - Proveedores
...
final supplierType = {
    ...
    "8" :DropdDownSItem(  name:"Administradora de Riesgos Laborales (ARL)",value:"8"),
    "9" :DropdDownSItem(  name:"Caja de compensación",value:"9"),
    "10":DropdDownSItem(  name:"Servicio Nacional de Aprendizaje (SENA)",value:"10")
};
