...
class DocumentsTypesProvider {
  ...
  static Future<List<Map<String, dynamic>>?> allDocumentsTypes(
    String billerId, {
    String module = '19',
  }) async {
  ...
  static Future<List<Map<String, dynamic>>?> findDocumentsTypes(
    ...
    return await DBProvider.db.sqlRawQuery(
        '''select * from sma_documents_types dt INNER JOIN sma_biller_documents_types bdt 
    ON dt.id_cloud = bdt.document_type_id AND bdt.biller_id = $billerId WHERE dt.module= '$module' AND dt.nombre LIKE "%$search%"''');
  }
